...
def get_checkpoint_save_path(cfg, arch, epoch):
    ...
    if arch == "DDPM-UNet":
        ...
        save_path = cfg.DATA_FS.SAVE_DIR+(cfg.MODEL.NAME.format(arch, cfg.MODEL.FLOW_MATCHING.TRAIN.EPOCHS, cfg.DATASET.PAST_LEN, cfg.DATASET.FUTURE_LEN, epoch, cfg.FLOW_MATCHING.W_TYPE))
    elif arch == "ConvGRU":
