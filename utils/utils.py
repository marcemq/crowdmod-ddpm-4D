...
def get_filenames_paths_base(cfg):
    ...
    elif cfg.DATASET.NAME in ["HERMES-T", "HERMES-BO", "HERMES-BN", "HERMES-CR-90", "HERMES-CR-90-OBST", "HERMES-CR-120", "HERMES-CR-120-OBST"]:
...
def get_checkpoint_save_path(cfg, arch, epoch):
    ...
    if arch in ["DDPM-UNet", "DDPM-DiT"]:
        ...
        save_path = cfg.DATA_FS.SAVE_DIR+(cfg.MODEL.NAME.format(arch, cfg.MODEL.CONVRNN.TRAIN.EPOCHS, cfg.DATASET.PAST_LEN, cfg.DATASET.FUTURE_LEN, epoch, base_cell))
    else:
